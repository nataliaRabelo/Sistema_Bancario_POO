...
public class ArquivoNumConta {

    private static ArquivoNumConta instancia;

    /**
     * Método responsável por atualizar o arquivo de numeros de contas.
    ...
    /**
     * Método responsável por construir o hashset de numeros de conta conforme o arquivo salvo.
     * @throws IOException
     ...
     * @return
     */
    public static ArquivoNumConta getInstancia() {
        if (instancia == null) {
            instancia = new ArquivoNumConta();
        }
        return instancia;
    }
}
